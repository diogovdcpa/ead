...
<div class="base-home">
    <div class="rows cursos py-3">
        <div class="col-3">
            <div class="caixa">
                <img src="<?php echo ASSETS ?>img/frontend.jpg">
                <div class="del-curso">
        ...
        <div class="col-3">
            <div class="caixa">
                <img src="<?php echo ASSETS ?>img/jsf-01.jpg">
                <div class="del-curso">
        ...
        <div class="col-3">
            <div class="caixa">
                <img src="<?php echo ASSETS ?>img/projeto-php.jpg">
                <div class="del-curso">
        ...
        <div class="col-3">
            <div class="caixa">
                <img src="<?php echo ASSETS ?>img/start-01.jpg">
                <div class="del-curso">
